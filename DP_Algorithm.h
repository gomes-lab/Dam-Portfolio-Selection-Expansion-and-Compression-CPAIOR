...
public:
    DP_Algorithm(const HyperNet &net, int root, const std::vector<std::string> &relevant_criteria, double epsilon,
                 unsigned int seed, bool use_n_squared, int batch_size, bool use_binary_tree, size_t num_threads, bool use_linear_preference, const std::vector<std::vector<double> > &w, std::string savename); // Constructor
    // Constructor
